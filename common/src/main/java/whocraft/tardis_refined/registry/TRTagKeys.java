...
public class TRTagKeys {
     ...
     */
    public static final TagKey<EntityType<?>> TARDIS_TELEPORT_BLACKLIST = TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, "tardis_teleport_blacklist"));
