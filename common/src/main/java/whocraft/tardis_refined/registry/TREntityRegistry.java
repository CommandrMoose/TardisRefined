...
public class TREntityRegistry {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(TardisRefined.MODID, Registries.ENTITY_TYPE);

    public static final RegistryHolder<EntityType<?>, EntityType<ControlEntity>> CONTROL_ENTITY = ENTITY_TYPES.register("console_control", () -> registerStatic(ControlEntity::new, MobCategory.MISC, 0.125F, 0.125F, 64, 40, "console_control"));
    ...
    public static <T extends Entity> EntityType<T> registerStatic(EntityType.EntityFactory<T> factory, MobCategory classification, float width, float height, int trackingRange, int updateFreq, String name) {
        ResourceLocation loc = ResourceLocation.fromNamespaceAndPath(TardisRefined.MODID, name);
