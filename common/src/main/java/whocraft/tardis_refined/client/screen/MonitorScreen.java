...
public class MonitorScreen extends SelectionScreen {
    ...
    public GenericMonitorSelectionList createSelectionList() {
        ...
        selectionList.children().add(new SelectionListEntry(Component.translatable(ModMessages.UI_MONITOR_VORTEX), entry -> Minecraft.getInstance().setScreen(new VortexSelectionScreen(VortexRegistry.VORTEX_DEFERRED_REGISTRY.getKey(VortexRegistry.FLOW.get()))), leftPos));
