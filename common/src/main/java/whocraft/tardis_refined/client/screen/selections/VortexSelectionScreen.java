...
public class VortexSelectionScreen extends SelectionScreen {
    ...
    public GenericMonitorSelectionList createSelectionList() {
        ...
        for (Map.Entry<ResourceKey<VortexRegistry>, VortexRegistry> shellTheme : VortexRegistry.VORTEX_DEFERRED_REGISTRY.entrySet()) {
            VortexRegistry theme = shellTheme.getValue();
