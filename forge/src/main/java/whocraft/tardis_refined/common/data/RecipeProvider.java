...
public class RecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, TRItemRegistry.TEST_TUBE.get()).pattern(" S ").pattern(" G ").pattern(" G ").define('G', Blocks.GLASS_PANE).define('S', Items.SLIME_BALL).unlockedBy("has_crafting_table", has(Blocks.STONE)).save(consumer);
